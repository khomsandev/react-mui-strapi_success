...
import { DASHBOARD_PATH, PRODUCT_PATH, REPORT_PATH, SETTING_PATH, PROFILE_NAME, PROFILE_ROLE } from "../config/constants"
    ...
    return (
        ...
        >
            <Box sx={styles.avatarContainer}>
                ...
                {!collapsed ? <Typography variant="body2" sx={styles.yourChannel}>{PROFILE_NAME}</Typography> : null }
                {!collapsed ? <Typography variant="body2">{PROFILE_ROLE}</Typography> : null }
            </Box>
